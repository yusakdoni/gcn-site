...
import { InsightsTeaser } from "@/components/layout/InsightsTeaser";
import { PartnerStatement } from "@/components/layout/PartnerStatement";
import { FinalCTA } from "@/components/layout/FinalCTA";
import { Footer } from "@/components/layout/Footer";

export default function HomePage() {
  return <main><Navbar/><Hero/><ValueProposition/><Services/><Industries/><HowWeWork/><CapabilityBand/><InsightsTeaser/><PartnerStatement/><FinalCTA/><Footer/></main>;
}
