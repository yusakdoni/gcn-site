    ...
    <main>
      ...
      <section className="pt-40 pb-16 bg-deep-blue relative overflow-hidden">
        ...
        <Container className="relative">
          <span className="eyebrow text-electric mb-6">Contact</span>
          <h1 className="text-white text-3xl md:text-h1 max-w-2xl">Discuss Your Requirement</h1>
        </Container>
      </section>
      ...
      <section className="py-20 bg-white">
        <Container className="grid md:grid-cols-5 gap-16">
          <div className="md:col-span-2 flex flex-col gap-10">
            <div>
              <span className="text-caption text-corporate/60 uppercase tracking-widest">Head Office</span>
            ...
            <div>
              <span className="text-caption text-corporate/60 uppercase tracking-widest">Email</span>
              <p className="text-body text-navy/80 mt-3">
            ...
            <div>
              <span className="text-caption text-corporate/60 uppercase tracking-widest">Response Time</span>
              <p className="text-body text-navy/80 mt-3">We respond to inquiries by email within 1–2 business days.</p>
            </div>
